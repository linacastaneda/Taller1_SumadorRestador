...
La implementación se realiza en Python, simulando el comportamiento interno de un circuito digital a nivel de hardware, como los utilizados en una Unidad Aritmético-Lógica (ALU).
...
Se demuestra que operaciones aritméticas complejas pueden construirse usando únicamente puertas lógicas básicas.

El diseño implementado replica fielmente el comportamiento de un circuito digital real.

Las pruebas unitarias garantizan la correcta operación del sistema.